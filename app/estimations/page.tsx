...
import { Sparkles, ShieldCheck, Clock, FileSearch, ArrowRight, Upload, Send } from "lucide-react";
          ...
          <form className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select className="w-full bg-black border border-neutral-800 rounded-xl px-4 py-3.5 text-neutral-300 focus:outline-none focus:border-amber-400 transition-colors text-sm">
                  <option value="tableau">Tableau / Peinture</option>
                  <option value="meuble">Meuble Ancien</option>
                  <option value="objet">Objet d&apos;Art / Sculpture</option>
                  <option value="tapisserie">Tapisserie</option>
                  <option value="monnaie">Monnaie / Numismatique</option>
                  <option value="autre">Autre bien d&apos;exception</option>
                </select>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-neutral-800 rounded-xl p-6 text-center hover:border-amber-500/40 transition-colors cursor-pointer bg-black/50">
            ...
            <button
              type="submit"
              className="w-full inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-500 to-yellow-400 hover:from-amber-600 hover:to-yellow-500 text-black font-semibold px-8 py-4 rounded-xl transition-all shadow-lg shadow-amber-500/10 hover:shadow-amber-500/25 uppercase tracking-wider text-sm mt-4"
            >
